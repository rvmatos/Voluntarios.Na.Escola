...
namespace VoluntariosNaEscola.Domain.Validations
{
    public class ValidationResult
    {
        ...
        public ValidationResult Add(string msgErroSystem, string msgErroUser, string stackTrace)
        {
            _erros.Add(new ValidationError(msgErroSystem, msgErroUser, stackTrace));
            return this;
        }
